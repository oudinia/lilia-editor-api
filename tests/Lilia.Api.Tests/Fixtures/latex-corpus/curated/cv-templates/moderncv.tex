% EXPECTED-LEAKS: item, enclname, makelettertitle, makeletterclosing
% (item leaks when itemize body falls through nested envs; framework
%  envs and letter-class commands are template-author specific.)
