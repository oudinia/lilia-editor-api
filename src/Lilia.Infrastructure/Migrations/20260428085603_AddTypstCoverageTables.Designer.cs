...
namespace Lilia.Infrastructure.Migrations
{
    ...
    [Migration("20260428085603_AddTypstCoverageTables")]
    partial class AddTypstCoverageTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Lilia.Core.Entities.Plan", b =>
                {
                    ...
                    b.ToTable("plans", null, t =>
                        {
                            t.HasCheckConstraint("ck_plan_slug", "slug IN ('free','student','pro','team','epub','compliance_pro','enterprise')");
                        });
                });
